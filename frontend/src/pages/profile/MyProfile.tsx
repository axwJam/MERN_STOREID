    ...
    <section className="w-full lg:flex-1 px-3 py-[15px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md max-w-none lg:max-w-[749px] mb-8">
      ...
      <form onSubmit={handleSave}>
        <div className="container w-full h-[17vh] relative">
          ...
          <div className="bg-blue-300 p-1 w-14 h-14 cursor-pointer rounded-full overflow-hidden absolute top-[2rem] ml-3" onClick={() => document.getElementById("uploadInput")?.click()}>
            {selectedImage ? (
              <div>
