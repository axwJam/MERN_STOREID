...
function Cart() {
  ...
  const removeFromFinalOrder = (itemId: string) => {
    setFinalOrder((prevOrder) => {
      const updatedItems = prevOrder.items.filter((item) => item._id !== itemId);
          ...
          <>
            ...
            <div className="flex gap-7 w-full mt-10 flex-wrap lg:flex-nowrap">
              <div className="md:w-full w-[100vw] min-w-0 xl:min-w-[715px] space-y-6">
                {cartItems.map(({ _id, totalPrice, quantity, type, price, brand, image }, i) => (
                      ...
                      <div className="grow shrink basis-0 h-[124px] justify-between items-center flex">
                        ...
                        <div className="h-[118px]  flex-col justify-between items-start inline-flex">
                          <div className="flex-col w-[40vw] md:ml-0 ml-5 md:w-[20vw] justify-start items-start gap-0.5 flex">
                            ...
                            <div className="text-zinc-800 text-xl font-semibold font-poppins">{type}</div>
                        ...
                        <div className="md:w-[225px] w-full gap-5 md:h-[124px] flex-col justify-between items-end  inline-flex">
                          <div className="h-6 justify-start items-start gap-4 inline-flex">
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => deleteCartItem(_id)} className="cursor-pointer">
                              <path
                            ...
                            <svg width="24" height="25" viewBox="0 0 24 25" fill={checkedItems.has(_id) ? "#0396C7" : "none"} xmlns="http://www.w3.org/2000/svg" onClick={() => toggleCheckbox(_id)} className="cursor-pointer border-2">
                          ...
                          <div className="lg:px-5 px-2 py-1 lg:py-3 bg-zinc-100 rounded-lg justify-center items-center gap-2 inline-flex">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => decrementQuantity(_id)} className="cursor-pointer">
                              <path
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => incrementQuantity(_id)} className="cursor-pointer">
                              <path
              ...
              <div className="w-full min-w-0 xl:min-w-[505px] px-6 py-5 bg-white rounded-[20px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex-col justify-start items-start gap-6 inline-flex h-min">
                ...
                <div className="self-stretch  flex-col justify-start items-start gap-5 flex">
                  {finalOrder.items.map(({ _id, totalPrice, type, brand, quantity }) => (
                    <div key={_id} className="self-stretch justify-between items-center inline-flex">
                ...
                {finalOrder.total !== 0 && (
                  <div onClick={clickProduct} className="cursor-pointer self-stretch h-[60px] md:px-[54px] px-3 text-center bg-sky-600 rounded-lg justify-center items-center gap-3 inline-flex">
